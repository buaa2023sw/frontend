<template>
    <div style="position:relative;width:100%;height: 100%;">
        <div id='burnup-chart' style="position: absolute;width: 80%;height:40%;left:10%;top:5%;"> 燃尽图 </div>
        <div ref="chart" style="position: absolute;width: 80%;height:40%;left:10%;top:52%"> 进度显示图 </div>
      <v-btn
        class="ma-2"
        color="primary"
        dark
    ...
    methods: {
      ...
      drawB() {
        ...
        if (actualDatesValue.length == 0) {
           ...
           dateMin = (expectedDatesValue[0] < actualDatesValue[0]) ?  expectedDatesValue[0] : actualDatesValue[0];
        }
